...
Pour le hardphone, on utilise son menu de configuration pour lui préciser son IP, l'IP du serveur Asterisk, l'utilisateur correspondant à ce poste (pour se logguer). Pour le softphone, on utilise les mêmes informations.
\clearpage
...
\noindent Ajoutons d'abord les autres serveurs Asterisk dans le fichier
